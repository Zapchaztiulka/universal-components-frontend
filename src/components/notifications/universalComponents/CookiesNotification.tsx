...
const CookiesNotification: FC<CookiesNotificationProps> =
    ({ className = "" }: CookiesNotificationProps) => {
        ...
        const sizeStyle = "w-[300px] tablet1024:w-[495px]";

        return (
            <div className={`fixed bottom-[24px] left-[50%] -translate-x-[50%] w-fit h-[72px] border-1 border-bgBrandDark rounded-medium3 px-s py-xs ${className}`}>
