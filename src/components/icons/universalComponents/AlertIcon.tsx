...
const AlertIcon = ({
    ...
    switch (variant) {
        case "error":
            alertIcon =
                <div className={`w-[59px] h-[59px] rounded-large2 bg-bgErrorLight flex place-content-center items-center`}>
        ...
        case "warning":
            alertIcon =
                <div className={`w-[59px] h-[59px] rounded-large2 bg-bgWarningLight flex place-content-center items-center`}>
        ...
        case "success":
            alertIcon =
                <div className={`w-[59px] h-[59px] rounded-large2 bg-bgSuccessLight flex place-content-center items-center`}>
